...
export const heroItem = {
  id: 1,
  image_url: "/zaeemkhan1999.jpeg",
  title: "hero",
  name: "Hello, I'm Muhammad Zaeem Khan",
  ...
  iconOne: {
    title: "GitHub",
    image_url: "",
    url: "https://github.com/zaeemkhan1999",
  },
  iconTwo: {
    title: "Linkedin",
    image_url: "",
    url: "https://www.linkedin.com/in/zaeemkhan1999/",
  },
};
...
export const aboutItem = {
  ...
  url: "https://www.linkedin.com/in/zaeemkhan1999/",
  description:
    "👋 Hey there! I'm Muhammad Zaeem Khan, a software engineer specializing in various stacks. I work with TypeScript, JavaScript, React, React Native, Next.js, Redux, Node.js, Express.js, MongoDB, PostgreSQL, Flutter and more. Passionate about creating helpful applications and assisting fellow developers. Let's connect and build impactful software solutions together.",
};
...
export const experienceItem = [
  {
    id: 1,
    company: "Cygnis Media",
    role: "Full Stack Developer",
    from: new Date(2023, 5, 1).getFullYear(),
    to: new Date(2023, 9, 1).getFullYear(),
    description:
  ...
  {
    id: 2,
    company: "GT Solutions USA · Full-time",
    role: "App Developer",
    from: new Date(2023, 8, 1).getFullYear(),
    to: "",
    description:
      "Deliver high-quality, robust production code for a diverse array of projects for clients including Harvard Business School, Everytown for Gun Safety, Pratt Institute, Koala Health, Vanderbilt University, The 19th News, and more. Provide leadership within engineering department through close collaboration, knowledge shares, and mentorship",
    stack: [
  ...
  contact_items: [
    {
      id: 1,
      title: "Email Me",
      url: "mailto:xnzaeemkhan1999@gmail.com",
    },
    {
      id: 2,
      title: "Call Me",
      url: "tel:+92-332-2931719",
    },
    {
      id: 3,
      title: "Linkedin",
